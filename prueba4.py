...
mayor_menor_nombre= ""
mayor_menor_partidas = 0
mayor_menor_racha = 0

numero_secreto_nombre = ""
numero_secreto_partidas = 0
numero_secreto_ganadas = 0
numero_secreto_perdidas = 0
...
def reporte():
    ...
    print("Mayor o Menor:")
    if mayor_menor_partidas == 0:
        print("No se han jugado partidas de Mayor o Menor.")
    else:
        print("Nombre del ultimo jugador:", mayor_menor_nombre)
        print("Número de partidas:", mayor_menor_partidas)
        print("Racha más alta:", mayor_menor_racha)
    

    print("\nNúmero Secreto:")
    if numero_secreto_partidas == 0:
        print("No se han jugado partidas de Número Secreto.")
    else:
        print("Nombre del ultimo jugador:", numero_secreto_nombre)
        print("Número de partidas:", numero_secreto_partidas)
        print("Partidas ganadas:", numero_secreto_ganadas)
        print("Partidas perdidas:", numero_secreto_perdidas)

    print("\nDados - Par e Impar:")
    if dados_partidas == 0:
        print("No se han jugado partidas de Dados - Par e Impar.")
    else:
        print("Nombre del ultimo jugador:", dados_nombre)
        print("Número de partidas:", dados_partidas)
        print("Partidas ganadas:", dados_ganadas)
        print("Partidas perdidas:", dados_perdidas)

#Juego 1: Mayor o Menor
def mayor_menor():
    global mayor_menor_nombre, mayor_menor_partidas, mayor_menor_racha
    ...
    mayor_menor_nombre = nombre
    mayor_menor_partidas += 1
    if cont_aciertos > mayor_menor_racha:
        mayor_menor_racha = cont_aciertos
    

def numero_secreto():
    global numero_secreto_nombre, numero_secreto_partidas, numero_secreto_ganadas, numero_secreto_perdidas
    ...
    numero_secreto_nombre = nombre
    numero_secreto_partidas += 1
    if acertado:
        numero_secreto_ganadas += 1
    else:
        numero_secreto_perdidas += 1
...
def dados_par_impar():
    global dados_nombre, dados_partidas, dados_ganadas, dados_perdidas
    #Juego Par o Impar
    ...
    dados_nombre = nombre
    dados_partidas += 1
    if cont_aciertos > dados_ganadas:
        dados_ganadas = cont_aciertos
    else:
        dados_perdidas += 1
